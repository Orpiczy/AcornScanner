    ...
    Rectangle {
        ...
        ChartView {
            ...
            BarSeries {
                ...
                BarSet { label: "Change Left"; values: [mapDecorator.ui_value0, mapDecorator.ui_value1, mapDecorator.ui_value2, mapDecorator.ui_value3, mapDecorator.ui_value4, mapDecorator.ui_value5, mapDecorator.ui_value6, mapDecorator.ui_value7] }
