...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_cm__data__EnumeratorDecorator_t, stringdata0) + ofs), len 
...
const QMetaObject cm::data::EnumeratorDecorator::staticMetaObject = { {
    ...
    qt_meta_stringdata_cm__data__EnumeratorDecorator.offsetsAndSize,
    qt_meta_data_cm__data__EnumeratorDecorator,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_cm__data__EnumeratorDecorator_t
, QtPrivate::TypeAndForceComplete<int, std::true_type>, QtPrivate::TypeAndForceComplete<QString, std::true_type>, QtPrivate::TypeAndForceComplete<EnumeratorDecorator, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
