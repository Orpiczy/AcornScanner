...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_cm__framework__Command_t, stringdata0) + ofs), len 
...
const QMetaObject cm::framework::Command::staticMetaObject = { {
    ...
    qt_meta_stringdata_cm__framework__Command.offsetsAndSize,
    qt_meta_data_cm__framework__Command,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_cm__framework__Command_t
